...
<body>
  ...
  <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasCart" aria-labelledby="My Cart">
    ...
    <div class="offcanvas-body">
      <div class="order-md-last">
        ...
        <div id="total-price" class="list-group-item d-flex justify-content-between">
              ...
              <ul class="d-flex justify-content-end list-unstyled m-0">
                ...
                <li class="">
                  <a href="#" class="mx-3" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart" aria-controls="offcanvasCart">
                    <iconify-icon icon="mdi:cart" class="fs-4 position-relative"></iconify-icon>
                    <span id="cartBadgeMain" class="position-absolute translate-middle badge rounded-circle bg-primary pt-2">
            0
        </span>
                  </a>
                </li>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide py-5">
            <div class="row banner-content align-items-center">
              ...
              <div class="content-wrapper col-md-7 p-5 mb-5">
                <div class="secondary-font text-primary text-uppercase mb-4">Save 10 - 20 % off</div>
                <h2 class="banner-title display-1 fw-normal">Your pet's paradise <span class="text-primary">starts
                    here</span>
                </h2>
                <a href="#" class="btn btn-outline-dark btn-lg text-uppercase fs-6 rounded-1">
                  shop now
          ...
          <div class="swiper-slide py-5">
            <div class="row banner-content align-items-center">
              ...
              <div class="content-wrapper col-md-7 p-5 mb-5">
                <div class="secondary-font text-primary text-uppercase mb-4">Save 10 - 20 % off</div>
                <h2 class="banner-title display-1 fw-normal">Where Pets are <span class="text-primary">Family
                    </span>
                </h2>
                <a href="#" class="btn btn-outline-dark btn-lg text-uppercase fs-6 rounded-1">
                  shop now
        ...
        <div class="swiper-wrapper">
            ...
            <div class="card position-relative">
              ...
              <div class="card-body p-0">
                ...
                <div class="card-text">
                  ...
                  <h3 class="secondary-font text-primary">$30.00</h3>

                  <div class="d-flex flex-wrap mt-3">
                    <a href="#" class="btn-cart me-3 px-4 pt-3 pb-3" data-name="Grey Hoodie" data-price=30>
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              ...
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0">Denim All-Over</h3>
                </a>
                ...
                <div class="card-text">
                  ...
                  <h3 class="secondary-font text-primary">$35.00</h3>

                  <div class="d-flex flex-wrap mt-3">
                    <a href="#" class="btn-cart me-3 px-4 pt-3 pb-3" data-name="Denim All-Over" data-price="35">
                      <h5 class="text-uppercase m-0">Add to Cart</h5>
                    </a>
                    <a href="#" class="btn-wishlist px-4 pt-3 ">
                      <iconify-icon icon="fluent:heart-28-filled" class="fs-5"></iconify-icon>
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              ...
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0">Pink Sweater</h3>
                </a>
                ...
                <div class="card-text">
                  ...
                  <div class="d-flex flex-wrap mt-3">
                    <a href="#" class="btn-cart me-3 px-4 pt-3 pb-3" data-name="Pink Sweater" data-price="30">
                      <h5 class="text-uppercase m-0">Add to Cart</h5>
                    </a>
                    <a href="#" class="btn-wishlist px-4 pt-3 ">
                      <iconify-icon icon="fluent:heart-28-filled" class="fs-5"></iconify-icon>
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              ...
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0">Black Shirt</h3>
                </a>
                ...
                <div class="card-text">
                  ...
                  <h3 class="secondary-font text-primary">$25.00</h3>

                  <div class="d-flex flex-wrap mt-3">
                    <a href="#" class="btn-cart me-3 px-4 pt-3 pb-3" data-name="Black Shirt" data-price="25">
                      <h5 class="text-uppercase m-0">Add to Cart</h5>
                    </a>
                    <a href="#" class="btn-wishlist px-4 pt-3 ">
                      <iconify-icon icon="fluent:heart-28-filled" class="fs-5"></iconify-icon>
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              ...
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0">Cat Food</h3>
                </a>
                ...
                <div class="card-text">
                  ...
                  <h3 class="secondary-font text-primary">$20.00</h3>

                  <div class="d-flex flex-wrap mt-3">
                    <a href="#" class="btn-cart me-3 px-4 pt-3 pb-3" data-name="Cat Food" data-price="20">
                      <h5 class="text-uppercase m-0">Add to Cart</h5>
                    </a>
                    <a href="#" class="btn-wishlist px-4 pt-3 ">
                      <iconify-icon icon="fluent:heart-28-filled" class="fs-5"></iconify-icon>
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              ...
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0">Chicken and Lamb</h3>
                </a>
                ...
                <div class="card-text">
                  ...
                  <div class="d-flex flex-wrap mt-3">
                    <a href="#" class="btn-cart me-3 px-4 pt-3 pb-3" data-name="Chicken and Lamb" data-price="25">
                      <h5 class="text-uppercase m-0">Add to Cart</h5>
                    </a>
                    <a href="#" class="btn-wishlist px-4 pt-3 ">
                      <iconify-icon icon="fluent:heart-28-filled" class="fs-5"></iconify-icon>
      ...
      <div class="isotope-container row">
        ...
        <div class="item cat col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            ...
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Kitty treats</h3>
              </a>
              ...
              <div class="card-text">
                ...
                <h3 class="secondary-font text-primary">$15.00</h3>

                <div class="d-flex flex-wrap mt-3">
                  <a href="#" class="btn-cart me-3 px-4 pt-3 pb-3" data-name="Kitty Treats" data-price="18">
                    <h5 class="text-uppercase m-0">Add to Cart</h5>
                  </a>
                  <a href="#" class="btn-wishlist px-4 pt-3 ">
                    <iconify-icon icon="fluent:heart-28-filled" class="fs-5"></iconify-icon>
        ...
        <div class="item dog col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            ...
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Pulsitos</h3>
              </a>
              ...
              <div class="card-text">
                ...
                <div class="d-flex flex-wrap mt-3">
                  <a href="#" class="btn-cart me-3 px-4 pt-3 pb-3" data-name="pulsitos" data-price="18">
                    <h5 class="text-uppercase m-0">Add to Cart</h5>
                  </a>
                  <a href="#" class="btn-wishlist px-4 pt-3 ">
                    <iconify-icon icon="fluent:heart-28-filled" class="fs-5"></iconify-icon>
        ...
        <div class="item cat col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            ...
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Foodies</h3>
              </a>
              ...
              <div class="card-text">
                ...
                <h3 class="secondary-font text-primary">$22.00</h3>

                <div class="d-flex flex-wrap mt-3">
                  <a href="#" class="btn-cart me-3 px-4 pt-3 pb-3" data-name="Foodies" data-price="22">
                    <h5 class="text-uppercase m-0">Add to Cart</h5>
                  </a>
                  <a href="#" class="btn-wishlist px-4 pt-3 ">
                    <iconify-icon icon="fluent:heart-28-filled" class="fs-5"></iconify-icon>
        ...
        <div class="item bird col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            ...
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Treats</h3>
              </a>
              ...
              <div class="card-text">
                ...
                <h3 class="secondary-font text-primary">$10.00</h3>

                <div class="d-flex flex-wrap mt-3">
                  <a href="#" class="btn-cart me-3 px-4 pt-3 pb-3" data-name="Treats" data-price="10">
                    <h5 class="text-uppercase m-0">Add to Cart</h5>
                  </a>
                  <a href="#" class="btn-wishlist px-4 pt-3 ">
                    <iconify-icon icon="fluent:heart-28-filled" class="fs-5"></iconify-icon>
        ...
        <div class="item bird col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            ...
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Happy Pets</h3>
              </a>
              ...
              <div class="card-text">
                ...
                <div class="d-flex flex-wrap mt-3">
                  <a href="#" class="btn-cart me-3 px-4 pt-3 pb-3" data-name="Happy Pets" data-price="25">
                    <h5 class="text-uppercase m-0">Add to Cart</h5>
                  </a>
                  <a href="#" class="btn-wishlist px-4 pt-3 ">
                    <iconify-icon icon="fluent:heart-28-filled" class="fs-5"></iconify-icon>
        ...
        <div class="item dog col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            ...
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Treatos</h3>
              </a>
              ...
              <div class="card-text">
                ...
                <div class="d-flex flex-wrap mt-3">
                  <a href="#" class="btn-cart me-3 px-4 pt-3 pb-3" data-name="Treatos" data-price="18">
                    <h5 class="text-uppercase m-0">Add to Cart</h5>
                  </a>
                  <a href="#" class="btn-wishlist px-4 pt-3 ">
                    <iconify-icon icon="fluent:heart-28-filled" class="fs-5"></iconify-icon>
        ...
        <div class="item cat col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            ...
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Munchies</h3>
              </a>
              ...
              <div class="card-text">
                ...
                <div class="d-flex flex-wrap mt-3">
                  <a href="#" class="btn-cart me-3 px-4 pt-3 pb-3" data-name="Munchies" data-price="20">
                    <h5 class="text-uppercase m-0">Add to Cart</h5>
                  </a>
                  <a href="#" class="btn-wishlist px-4 pt-3 ">
                    <iconify-icon icon="fluent:heart-28-filled" class="fs-5"></iconify-icon>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              ...
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0">Dog House</h3>
                </a>
                ...
                <div class="card-text">
                  ...
                  <h3 class="secondary-font text-primary">$50.00</h3>

                  <div class="d-flex flex-wrap mt-3">
                    <a href="#" class="btn-cart me-3 px-4 pt-3 pb-3" data-name="Dog House" data-price="50">
                      <h5 class="text-uppercase m-0">Add to Cart</h5>
                    </a>
                    <a href="#" class="btn-wishlist px-4 pt-3 ">
                      <iconify-icon icon="fluent:heart-28-filled" class="fs-5"></iconify-icon>
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              ...
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0">Dog Food</h3>
                </a>
                ...
                <div class="card-text">
                  ...
                  <div class="d-flex flex-wrap mt-3">
                    <a href="#" class="btn-cart me-3 px-4 pt-3 pb-3" data-name="Dog Food" data-price="35">
                      <h5 class="text-uppercase m-0">Add to Cart</h5>
                    </a>
                    <a href="#" class="btn-wishlist px-4 pt-3 ">
                      <iconify-icon icon="fluent:heart-28-filled" class="fs-5"></iconify-icon>
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              ...
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0">Yellow hoodie</h3>
                </a>
                ...
                <div class="card-text">
                  ...
                  <div class="d-flex flex-wrap mt-3">
                    <a href="#" class="btn-cart me-3 px-4 pt-3 pb-3" data-name="Yellow Sweater" data-price="25">
                      <h5 class="text-uppercase m-0">Add to Cart</h5>
                    </a>
                    <a href="#" class="btn-wishlist px-4 pt-3 ">
                      <iconify-icon icon="fluent:heart-28-filled" class="fs-5"></iconify-icon>
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              ...
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0">Sleeping Shirt</h3>
                </a>
                ...
                <div class="card-text">
                  ...
                  <div class="d-flex flex-wrap mt-3">
                    <a href="#" class="btn-cart me-3 px-4 pt-3 pb-3" data-name="Sleeping Shirt" data-price="18">
                      <h5 class="text-uppercase m-0">Add to Cart</h5>
                    </a>
                    <a href="#" class="btn-wishlist px-4 pt-3 ">
                      <iconify-icon icon="fluent:heart-28-filled" class="fs-5"></iconify-icon>
            ...
            <div class="card position-relative">
              ...
              <div class="card-body p-0">
                ...
                <div class="card-text">
                  ...
                  <div class="d-flex flex-wrap mt-3">
                    <a href="#" class="btn-cart me-3 px-4 pt-3 pb-3" data-name="Grey Sweater" data-price="30">
                      <h5 class="text-uppercase m-0">Add to Cart</h5>
                    </a>
                    <a href="#" class="btn-wishlist px-4 pt-3 ">
                      <iconify-icon icon="fluent:heart-28-filled" class="fs-5"></iconify-icon>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      var cartBadge = document.getElementById('cartBadgeMain'); // Select the cart badge on the main page
      var checkoutButton = document.querySelector('.btn-primary'); // Select the "Continue to checkout" button

      // Initialize cart item count to 0
      var cartItemCount = 0;
      var cartItems = {}; // Object to store cart items with their quantities
      ...
      addToCartButtons.forEach(function(button) {
        button.addEventListener('click', function(event) {
          ...
          // Display "Added to cart successfully" message
          alert(productName + " added to cart successfully");

          // Check if the product is already in the cart
          if (cartItems.hasOwnProperty(productName)) {
            cartItems[productName].quantity++; // Increment quantity
          } else {
            cartItems[productName] = { price: productPrice, quantity: 1 }; // Add new item to cart
          }
          ...
          // Update cart in session storage and display
          updateCart();
        });
      });
      ...
      function updateCart() {
        ...
        // Iterate through cartItems object
        Object.keys(cartItems).forEach(function(productName) {
          ...
          productPriceElement.classList.add('text-body-secondary');
          productPriceElement.textContent = '$' + item.price.toFixed(2);

          // Product quantity element
          var productQuantityElement = document.createElement('span');
          productQuantityElement.textContent = 'x' + item.quantity;

          // Decrease button
          var decreaseButton = document.createElement('button');
          decreaseButton.classList.add('btn', 'btn-secondary', 'btn-sm', 'decrease-item');
          ...
          listItem.appendChild(productQuantityElement);
          listItem.appendChild(productPriceElement);
        ...
        var totalPrice = Object.keys(cartItems).reduce(function(total, productName) {
          return total + (cartItems[productName].price * cartItems[productName].quantity);
        }, 0);
      ...
      // Function to save cart items to session storage
      function saveCartItems() {
        sessionStorage.setItem('cartItems', JSON.stringify(cartItems));
      }

      // Event listener for the "Continue to checkout" button
      checkoutButton.addEventListener('click', function() {
        // Display "Order placed successfully" message
        alert("Order placed successfully");

        // Display bill
        var bill = "Order Details:\n";
        Object.keys(cartItems).forEach(function(productName) {
          var item = cartItems[productName];
          bill += productName + " x" + item.quantity + " - $" + (item.price * item.quantity).toFixed(2) + "\n";
        });
        bill += "\nTotal: $" + totalPriceElement.textContent.substring(1);
        alert(bill);
